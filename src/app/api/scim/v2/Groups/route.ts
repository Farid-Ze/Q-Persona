...
export async function GET(request: NextRequest) {
  ...
  // List/Query Groups per SCIM spec
  return NextResponse.json({ detail: 'SCIM Groups listing not implemented yet' }, { status: 501 })
}
...
export async function POST(request: NextRequest) {
  ...
  // Create Group
  return NextResponse.json({ detail: 'SCIM Group creation not implemented yet' }, { status: 501 })
}
